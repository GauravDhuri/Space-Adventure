...
class PowerUpManager extends Component with HasGameReference<SpacescapeGame> {
  ...
  void onMount() {
    ...
    healthSprite = Sprite(game.images.fromCache('Health.png'));
    nukeSprite = Sprite(game.images.fromCache('Thunder_strike.png'));
    freezeSprite = Sprite(game.images.fromCache('Freeze.png'));
    multiFireSprite = Sprite(game.images.fromCache('Double_Fire.png'));
